  ...
  return (
    <div className="player">
      ...
      <div className="pieces">
        <div>
          <div draggable={turn ? 'true' : 'false'} id="small1" className="piece s-piece player1" 
            onDragStart={(e) => {handleDragStart(e)}}>x{small}</div>
        </div>
        <div>
          <div draggable={turn ? 'true' : 'false'} id="medium1" className="piece m-piece player1" 
            onDragStart={(e) => {handleDragStart(e)}}>x{medium}</div>
        </div>
        <div>
          <div draggable={turn ? 'true' : 'false'} id="large1" className="piece l-piece player1"
